//+------------------------------------------------------------------+
//| SimpleNY200 v1.2 - New York Opening Range Breakout Strategy     |
...
//| v1.2: FIX - Correcci贸n bug reset diario (Opening Range)         |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, Bittrader Development Team"
#property link      "https://www.youtube.com/@bittrader9259"
#property version   "1.20"
#property description "SimpleNY200 v1.2 - NY Opening Range con FIX reset diario"
#property strict
...
input string          EAIdentifier        = "SimpleNY200_v1.1";  // Identificador del EA
...
int OnInit()
{
    ...
    if(EnableFileLogging) {
        ...
        if(g_FileHandle != INVALID_HANDLE) {
            ...
            FileWrite(g_FileHandle, "鈺�   SimpleNY200 v1.1 - Session Log [FIX APPLIED]    鈺�");
    ...
    LogMessage("鉁� SimpleNY200 v1.2 inicializado correctamente [DAILY RESET FIX ACTIVE]", LOG_INFO);
...
{
    LogMessage("SimpleNY200 v1.1 deinicializando - Raz贸n: " + IntegerToString(reason), LOG_INFO);
    ...
    Print("SimpleNY200 v1.2 deinicializado exitosamente [DAILY RESET FIX]");
}
