//+------------------------------------------------------------------+
//| SimpleNY200 v1.1 - New York Opening Range Breakout Strategy     |
...
//| v1.1: FIX - Correcci贸n bug detecci贸n sesi贸n NY + Logs          |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, Bittrader Development Team"
#property link      "https://www.youtube.com/@bittrader9259"
#property version   "1.10"
#property description "SimpleNY200 v1.1 - NY Opening Range con FIX sesi贸n"
#property strict
...
int OnInit()
{
    ...
    LogMessage("鉁� SimpleNY200 v1.1 inicializado correctamente [SESSION FIX ACTIVE]", LOG_INFO);
...
void OnDeinit(const int reason)
{
    ...
    Print("SimpleNY200 v1.1 deinicializado exitosamente [SESSION FIX VERSION]");
}
